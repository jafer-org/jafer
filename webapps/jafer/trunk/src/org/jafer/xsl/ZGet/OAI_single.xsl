      ...
      <xsl:choose>
        <xsl:when test="oai_marc:subfield[@label='x']">
          <tr>
            ...
            <td colspan="3"><a href="ZGet?issn={$identifier}"><xsl:value-of select="oai_marc:subfield[@label='t']"/></a></td>
          </tr>
        </xsl:when>
        <xsl:when test="oai_marc:subfield[@label='z']">
          <tr>
            <td width="15%"><b>Related Item</b></td>
            <td colspan="3"><a href="ZGet?isbn={$identifier}"><xsl:value-of select="oai_marc:subfield[@label='t']"/></a></td>
          </tr>
        </xsl:when>
        <xsl:when test="oai_marc:subfield[@label='w']">
          <tr>
            <td width="15%"><b>Related Item</b></td>
            <td colspan="3"><a href="ZGet?docid={substring($identifier, 8, 8)}"><xsl:value-of select="oai_marc:subfield[@label='t']"/></a></td>
          </tr>
        </xsl:when>
        <xsl:otherwise>
          <tr>
