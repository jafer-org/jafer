      ...
      <xsl:choose>
        <xsl:when test="mods:identifier[@type='isbn']">
          <tr>
            ...
            <td colspan="3"><a href="OpenURL?isbn={$identifier}"><xsl:value-of select="mods:title"/></a></td>
          </tr>
        </xsl:when>
        <xsl:when test="mods:identifier[@type='issn']">
          <tr>
            <td width="15%"><b>Related Item</b></td>
            <td colspan="3"><a href="OpenURL?issn={$identifier}"><xsl:value-of select="mods:title"/></a></td>
          </tr>
        </xsl:when>
        <xsl:otherwise>
          <tr>
